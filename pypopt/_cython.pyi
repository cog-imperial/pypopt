...
class Journal(Any):
    def name(self) -> str: ...
    def set_print_level(self, category: EJournalCategory, level: EJournalLevel): ...
    def set_all_print_levels(self, level: EJournalLevel): ...
    def is_accepted(self,  category: EJournalCategory, level: EJournalLevel) -> bool: ...
    def print_(self, category: EJournalCategory, level: EJournalLevel, str_: bytes): ...
